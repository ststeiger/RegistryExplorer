...
namespace UI.Controls
{
    ...
    public partial class AboutCtrl 
        : UserControl
    {
        const string COPYRIGHT_TEXT = "Copyright (C) {0} ACME Corp. Inc.";
        int copyrightSince = System.DateTime.Now.Year;
        bool beta;
        ...
        private void AboutCtrl_AutoSizeChanged(object sender, System.EventArgs e)
        {
            AdjustSize();
        }
